...
abstract class ReviewsBase with Store {
  ...
  @computed
  int get numbreOfReviews => reviews.length;
  ...
  double _calculateAverageStars(int newStar) {
    return (newStar + totalStars) / numbreOfReviews;
  }
